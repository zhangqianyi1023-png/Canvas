  ...
  return (
    <div className={`custom-node three-d-node ${selected ? 'selected' : ''}`}>
      ...
      <div className="node-header">
        <EditableNodeTitle icon={<Icon name="cube" size={16} />} value={data?.label || '3D Viewfinder'} fallback="3D Viewfinder" onChange={(value) => data?.onNodeTitleChange?.(id, value)} onEditingChange={setIsTitleEditing} />
